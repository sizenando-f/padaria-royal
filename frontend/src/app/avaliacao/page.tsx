    ...
    <div className="min-h-screen bg-gray-50 p-4 pb-24 md:p-8">
      <div className="max-w-xl mx-auto">
        ...
        <div className="flex items-center gap-4 mb-6">
          <button
            onClick={() => router.push("/")}
            className="bg-white p-3 rounded-full border border-gray-200 shadow-sm text-gray-700 active:bg-gray-100"
          >
            <ArrowLeft size={20} />
          </button>
          <div>
          ...
          <div className="bg-orange-100 border border-orange-200 text-orange-800 p-4 rounded-3xl mb-6 flex items-center gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-xs opacity-90">
                Você tem {pendentes.length} produções aguardando nota.
              </p>
            </div>
          </div>
        )}
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 text-center animate-fade-in">
            ...
            <p className="text-gray-500 text-sm max-w-xs mt-2">
              Nenhuma produção pendente. Você pode ver o histórico completo ou
              iniciar uma nova.
            </p>
            <button
              onClick={() => router.push("/")}
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-1 text-xs text-gray-400 font-medium">
                        <Calendar size={12} />
                        {new Date(prod.dataProducao).toLocaleDateString(
                          "pt-BR",
                        )}
                      </div>
                    </div>
                ...
                <div className="bg-gray-50 rounded-2xl p-3 grid grid-cols-2 gap-4 mb-4">
                  ...
                  <div className="space-y-1 border-l border-gray-200 pl-4">
                    ...
                    <div className="flex items-center gap-2 text-gray-700 font-bold">
                      ...
                      {formatarHora(prod.horaInicio)} -{" "}
                      {formatarHora(prod.horaFim)}
                    </div>
                  </div>
                </div>
